...
public class EListView extends ListView implements OnScrollListener {
    ...
    private final static int NET_STATE_ON = 1;//1在线，0离线
    ...
    private int netstate = NET_STATE_ON;//网络状态
    ...
    private void init(Context context) {
        ...
        headView = (LinearLayout) inflater
                .inflate(R.layout.headerrefresh, null);// listview拼接headview
